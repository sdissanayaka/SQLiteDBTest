...
public class MainActivity extends AppCompatActivity {
    ...
    public void insertData(View view) {
        ...
        EditText surname = (EditText) findViewById(R.id.ditTextSurname);
        EditText marks = (EditText) findViewById(R.id.editTextMarks);
        boolean executed =
                databaseHelper.insertData(fName.getText().toString(), surname.getText().toString(),Integer.parseInt(marks.getText().toString()));
        if (executed) {
    ...
    public void updateData(View view) {
        ...
        if (!id.equals("Select ID")) {
            ...
            EditText marks = (EditText) findViewById(R.id.editTextMarks2);
            boolean executed =
                    databaseHelper.updateData(id, fName.getText().toString(), surname.getText().toString(), Integer.parseInt(marks.getText().toString()));
            if (executed) {
